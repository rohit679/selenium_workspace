...
def fill_payment_details():
    ...
    account_number = driver.find_element_by_xpath("//input[@type='tel' and \
    ...
    submit = driver.find_element_by_xpath("//button[@type='submit' and \
                                          @class='Button-animationWrapper-child--primary Button']")
    submit.click()
